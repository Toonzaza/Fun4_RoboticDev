...
#ifndef FUN4_INTERFACES__SRV__DETAIL__MODE__FUNCTIONS_H_
#define FUN4_INTERFACES__SRV__DETAIL__MODE__FUNCTIONS_H_
 ...
 * calls
 * fun4_interfaces__srv__Mode_Request__init().
...
/**
 * It calls
 * fun4_interfaces__srv__Mode_Request__fini()
 ...
 * fun4_interfaces__srv__Mode_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * fun4_interfaces__srv__Mode_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * fun4_interfaces__srv__Mode_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_fun4_interfaces
...
/**
 * It calls
 * fun4_interfaces__srv__Mode_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_fun4_interfaces
...
/**
 * It allocates the memory for the array and calls
 * fun4_interfaces__srv__Mode_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_fun4_interfaces
...
/**
 * It calls
 * fun4_interfaces__srv__Mode_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // FUN4_INTERFACES__SRV__DETAIL__MODE__FUNCTIONS_H_
